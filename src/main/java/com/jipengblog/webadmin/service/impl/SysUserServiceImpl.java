...
public class SysUserServiceImpl implements SysUserService {
	...
	public SysUser findByLoginName(String loginName) {
		return baseRepository.getOneByHQL("from SysUser where loginName = ?0", loginName);
	}

	@Override
	public SysUser findByEmail(String email) {
		return baseRepository.getOneByHQL("from SysUser where email = ?0", email);
	}

	@Override
	public SysUser findByMobile(String mobile) {
		return baseRepository.getOneByHQL("from SysUser where mobile = ?0", mobile);
	}
